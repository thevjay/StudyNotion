    ...
    <div>
      ...
      <section className='bg-richblack-700'>
            <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                <header className='mx-auto py-20 text-xl font-semibold lg:w-[70%]'>
      ...
      {/* section 3 */}
      <section>
        <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblue-500'>
            {/* founding story wala div */}
            <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                {/* founding story left box */}
                <div className='my-12 flex lg:w-[50%] flex-col gap-10'>
                    <h1 className='bg-gradient-to-br form-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] text-white'>Our Founding Story</h1>
            ...
            <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                ...
                <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                    <h1 className='text-4xl font-semibold text-transparent lg:w-[70%] '>Our vision</h1>
                ...
                {/* right box */}
                <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                    <h1 className='bg-gradient-to-b from-[#1FA2FF] via-[#A6FFCB] text-transparent bg-clip-text text-4xl font-semibold lg:w-[70%]'>Our vision</h1>
      ...
      <div className='mx-auto my-20 flex max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white'>
